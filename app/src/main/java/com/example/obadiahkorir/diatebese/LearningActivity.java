        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(number==0){
                    ...
                    Intent i=new Intent(LearningActivity.this,CoursesActivity.class);
                    startActivity(i);
                }

                else if(number==1){
                    Intent i=new Intent(LearningActivity.this,PreventionActivity.class);
                    startActivity(i);

                }
                else if(number==2){
                    Intent i=new Intent(LearningActivity.this,NutritionsActivity.class);
                    startActivity(i);
